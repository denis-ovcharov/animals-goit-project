import{A as V,a as y,S as H,N as _,P as T,i as u,b as F}from"./assets/vendor-CyB7JiL4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const j=document.getElementById("mobile-menu"),W=document.getElementById("data-burger-close"),Y=document.getElementById("data-burger-open"),K=document.querySelectorAll(".mobile-nav-list a");function M(){j.classList.remove("is-open"),document.body.style.overflow="visible"}function Q(){j.classList.add("is-open"),document.body.style.overflow="hidden"}W.addEventListener("click",M);Y.addEventListener("click",Q);K.forEach(e=>e.addEventListener("click",M));document.addEventListener("keydown",M);const X=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`
  ...
  `,{onShow:t=>{const s=document.querySelector(".basicLightbox .pet-modal");s&&(s.style.overflow="auto"),document.body.style.overflow="hidden",t.element().querySelector(".pet-modal-close").addEventListener("click",()=>t.close()),t.element().querySelector(".pet-modal-btn").addEventListener("click",()=>t.close()),document.addEventListener("keydown",P)},onClose:()=>{document.body.style.overflow="visible",document.removeEventListener("keydown",P)}}),p.show()}function P(e){e.key==="Escape"&&p.close()}function me(e){let t=e.replace(/\D/g,"");return t.length===10&&t.startsWith("0")&&(t="38"+t),t}function fe(e){const t=F.create(`
    ...
    `,{onShow:s=>{document.body.style.overflow="hidden";const n=s.element(),o=n.querySelector(".modal-order-close-btn"),r=n.querySelector("[data-modal-order-form]"),i=n.querySelector("#user-name"),c=n.querySelector("#user-phone"),l=n.querySelector("#user-comment"),v=n.querySelector(".form-submit-btn");o.addEventListener("click",()=>s.close());const g=m=>{m.key==="Escape"&&s.close()};document.addEventListener("keydown",g),s._onEscClose=g,r.addEventListener("submit",async m=>{var C,A,R;m.preventDefault();const E=i.value.trim(),B=me(c.value),q=l.value.trim();if(!e){u.error({message:"Не обрано тварину",position:"topRight"});return}if(!E||E.length>32){u.error({message:"Імʼя обовʼязкове (до 32 символів)",position:"topRight"}),i.focus();return}if(!/^[0-9]{12}$/.test(B)){u.error({message:"Телефон має містити 12 цифр (приклад: 380955559922)",position:"topRight"}),c.focus();return}if(q&&q.length>500){u.error({message:"Коментар не може перевищувати 500 символів",position:"topRight"}),l.focus();return}const G={name:E,phone:B,animalId:e,comment:q||void 0};try{v.disabled=!0,k(),await re(G),u.success({title:"Успішно",message:"Заявку відправлено",position:"topRight"}),s.close()}catch(d){console.error(((C=d==null?void 0:d.response)==null?void 0:C.data)||d.message),u.error({title:"Помилка",message:((R=(A=d==null?void 0:d.response)==null?void 0:A.data)==null?void 0:R.message)||"Не вдалося відправити заявку",position:"topRight"})}finally{$(),v.disabled=!1}})},onClose:s=>{document.body.style.overflow="visible",$(),s!=null&&s._onEscClose&&document.removeEventListener("keydown",s._onEscClose)}});p==null||p.close(),k(),t.show()}//!=============================================================
let f=1,O=1,h=8,U="",x=[];//!=============================================================
...
async function L(){k();try{const{animals:e,totalItems:t}=await oe({page:f,limit:h,categoryId:U});if(x.push(...e),e.length===0){b();return}ge(e),O=Math.ceil(t/h),f<O?be():b(),f++}catch(e){console.error("API error:",e)}finally{$()}}//!===============================================================================
...
document.addEventListener("click",e=>{if(e.target.classList.contains("pet-details-btn")){const t=e.target.dataset.id,s=x.find(n=>n._id===t);if(!s)return;pe(s)}});//!=======================================================================================
const D=window.matchMedia("(min-width: 1440px)");let I=!1;function z(e){const t=e.matches?9:8;if(!I){I=!0,h=t;return}h!==t&&(h=t,f=1,x=[],a.petsList.innerHTML="",L())}D.addEventListener("change",z);z(D);document.addEventListener("DOMContentLoaded",ae);document.addEventListener("DOMContentLoaded",ue);document.addEventListener("DOMContentLoaded",he);
