import{A as G,a as w,S as H,N as _,P as T,i as u,b as F}from"./assets/vendor-CyB7JiL4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const h=document.getElementById("mobile-menu"),V=document.getElementById("data-burger-close");V.addEventListener("click",()=>{h.classList.remove("is-open"),document.body.style.overflow="visible"});const W=document.getElementById("data-burger-open");W.addEventListener("click",()=>{h.classList.add("is-open"),document.body.style.overflow="hidden"});const Y=document.querySelectorAll(".nav-link");Y.forEach(e=>{e.addEventListener("click",()=>{h.classList.remove("is-open"),document.body.style.overflow="visible"})});document.addEventListener("keydown",e=>{e.key==="Escape"&&h.classList.contains("is-open")&&(h.classList.remove("is-open"),document.body.style.overflow="visible")});const K=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`
  ...
  `}],Q=document.getElementById("faqAccordion");Q.innerHTML=K.map(e=>`
    <div class="ac">
      <h3 class="ac-header">
  ...
  `).join("");new G("#faqAccordion",{duration:300,showMultiple:!1});document.querySelectorAll(".ac-trigger").forEach(e=>{e.addEventListener("click",()=>{const t=e.parentElement.nextElementSibling;t.style.maxHeight?t.style.maxHeight=null:t.style.maxHeight=t.scrollHeight+"px"})});const L="https://paw-hut.b.goit.study",X=`${L}/api/animals`,J=`${L}/api/categories`,Z=`${L}/api/orders`,ee=`${L}/api/feedbacks`;async function te({page:e=1,limit:t=10,categoryId:s}){const n={page:e,limit:t};return s&&(n.categoryId=s),(await w.get(X,{params:n})).data}async function se(){return(await w.get(J)).data}async function oe(e){return(await w.post(Z,e)).data}async function ne(e=10,t=1){return(await w.get(ee,{params:{page:t,limit:e}})).data}async function re(){const e=document.querySelector("#feedback");if(!e)return;const t=e.querySelector(".swiper.feedback-swiper"),s=e.querySelector(".swiper-wrapper"),n=e.querySelector(".feedback-swiper-pagination"),o=e.querySelector(".feedback-swiper-button-next"),r=e.querySelector(".feedback-swiper-button-prev");e.querySelector(".loader");try{const i=Math.floor(Math.random()*9)+1,l=(await ne(5,i)).feedbacks;if(!Array.isArray(l)||l.length<3)throw new Error("Not enough feedbacks (min 3 required)");s.innerHTML=l.map(ie).join(""),new H(t,{modules:[_,T],speed:1e3,slidesPerView:1,spaceBetween:16,loop:!1,resistanceRatio:.85,touchRatio:1.2,breakpoints:{768:{slidesPerView:2,spaceBetween:32},1440:{slidesPerView:2,spaceBetween:32}},pagination:{el:n,clickable:!0,dynamicBullets:!0},navigation:{nextEl:o,prevEl:r,disabledClass:"is-disabled"}})}catch(i){console.error(i),u.error({title:"Error",message:i.message,position:"topRight"})}}function ie(e){const t=(e==null?void 0:e.author)??"User",s=(e==null?void 0:e.description)??"",n=ae((e==null?void 0:e.rate)??0),o=Math.floor(n),r=n%1>=.5,i=`rating value-${o}${r?" half":""} star-icon`,c=Array.from({length:5}).map(()=>`
        <div class="star">
    ...
    `}function ae(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,t)):0}const k=document.querySelector(".scroll-top"),le=300;window.addEventListener("scroll",()=>{window.scrollY>le?k.classList.add("is-on"):k.classList.remove("is-on")});k.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});function ce(){const e=document.querySelector("#about-us");if(!e)return;const t=e.querySelector(".swiper.mySwiper"),s=e.querySelector(".swiper-button-next"),n=e.querySelector(".swiper-button-prev"),o=e.querySelector(".swiper-pagination");new H(t,{modules:[_,T],cssMode:!1,navigation:{nextEl:s,prevEl:n},pagination:{el:o,clickable:!0,dynamicBullets:!1},mousewheel:!0,keyboard:!0,speed:1e3,parallax:!0})}const j="/animals-goit-project/assets/sprite-BFbGGHrj.svg";let p=null;function de(e){p=F.create(`
   <div class="pet-modal">
  ...
  `,{onShow:t=>{const s=document.querySelector(".basicLightbox .pet-modal");s&&(s.style.overflow="auto"),document.body.style.overflow="hidden",t.element().querySelector(".pet-modal-close").addEventListener("click",()=>t.close()),t.element().querySelector(".pet-modal-btn").addEventListener("click",()=>t.close()),document.addEventListener("keydown",P)},onClose:()=>{document.body.style.overflow="visible",document.removeEventListener("keydown",P)}}),p.show()}function P(e){e.key==="Escape"&&p.close()}function ue(e){let t=e.replace(/\D/g,"");return t.length===10&&t.startsWith("0")&&(t="38"+t),t}function pe(e){const t=F.create(`
    ...
    `,{onShow:s=>{document.body.style.overflow="hidden";const n=s.element(),o=n.querySelector(".modal-order-close-btn"),r=n.querySelector("[data-modal-order-form]"),i=n.querySelector("#user-name"),c=n.querySelector("#user-phone"),l=n.querySelector("#user-comment"),g=n.querySelector(".form-submit-btn");o.addEventListener("click",()=>s.close());const b=m=>{m.key==="Escape"&&s.close()};document.addEventListener("keydown",b),s._onEscClose=b,r.addEventListener("submit",async m=>{var C,R,A;m.preventDefault();const q=i.value.trim(),B=ue(c.value),S=l.value.trim();if(!e){u.error({message:"Не обрано тварину",position:"topRight"});return}if(!q||q.length>32){u.error({message:"Імʼя обовʼязкове (до 32 символів)",position:"topRight"}),i.focus();return}if(!/^[0-9]{12}$/.test(B)){u.error({message:"Телефон має містити 12 цифр (приклад: 380955559922)",position:"topRight"}),c.focus();return}if(S&&S.length>500){u.error({message:"Коментар не може перевищувати 500 символів",position:"topRight"}),l.focus();return}const z={name:q,phone:B,animalId:e,comment:S||void 0};try{g.disabled=!0,$(),await oe(z),u.success({title:"Успішно",message:"Заявку відправлено",position:"topRight"}),s.close()}catch(d){console.error(((C=d==null?void 0:d.response)==null?void 0:C.data)||d.message),u.error({title:"Помилка",message:((A=(R=d==null?void 0:d.response)==null?void 0:R.data)==null?void 0:A.message)||"Не вдалося відправити заявку",position:"topRight"})}finally{M(),g.disabled=!1}})},onClose:s=>{document.body.style.overflow="visible",M(),s!=null&&s._onEscClose&&document.removeEventListener("keydown",s._onEscClose)}});p==null||p.close(),$(),t.show()}//!=============================================================
let f=1,O=1,v=8,N="",x=[];//!=============================================================
async function me(){const e=await se(),t=["Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"],s=[...e].sort((n,o)=>{const r=t.indexOf(n.name),i=t.indexOf(o.name);return r===-1?1:i===-1?-1:r-i});fe(s),await E()}//!=============================================================
...
function fe(e){const s=[{name:"Всі",_id:""},...e].map(o=>`<li class="pets-filters-item"><button class="pets-filters-btn" data-category-id="${o._id}">${o.name}</button></li>`).join("");a.petsFilters.innerHTML=s;const n=document.querySelector(".pets-filters-btn");n&&n.classList.add("pets-filters-btn-active")}//!=============================================================
function ve(e){const t=e.map(({_id:s,name:n,image:o,species:r,age:i,gender:c,shortDescription:l,categories:g})=>{const b=g.map(m=>`<p class="pet-category">${m.name}</p>`).join("");return`
        <li class="pet-card">
...
async function E(){$();try{const{animals:e,totalItems:t}=await te({page:f,limit:v,categoryId:N});if(x.push(...e),e.length===0){y();return}ve(e),O=Math.ceil(t/v),f<O?he():y(),f++}catch(e){console.error("API error:",e)}finally{M()}}//!===============================================================================
...
a.loadMoreBtn.addEventListener("click",async()=>{y(),await E(),ge()});//!===============================================================================
...
a.petsFilters.addEventListener("click",e=>{y();const t=e.target.closest(".pets-filters-btn");t&&(document.querySelectorAll(".pets-filters-btn").forEach(s=>s.classList.remove("pets-filters-btn-active")),t.classList.add("pets-filters-btn-active"),N=t.dataset.categoryId||"",f=1,a.petsList.innerHTML="",E())});//!=================================================================================
...
const U=window.matchMedia("(min-width: 1440px)");let I=!1;function D(e){const t=e.matches?9:8;if(!I){I=!0,v=t;return}v!==t&&(v=t,f=1,x=[],a.petsList.innerHTML="",E())}U.addEventListener("change",D);D(U);document.addEventListener("DOMContentLoaded",re);document.addEventListener("DOMContentLoaded",ce);document.addEventListener("DOMContentLoaded",me);
