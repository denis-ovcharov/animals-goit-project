import{A as Y,a as k,S as U,N as F,P as W,i as p,b as j}from"./assets/vendor-CyB7JiL4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const A=document.getElementById("mobile-menu"),K=document.getElementById("data-burger-close"),X=document.getElementById("data-burger-open"),N=document.querySelector(".mobile-menu");function D(e){e.key==="Escape"&&A.classList.contains("is-open")&&H()}function G(e){e.target.closest("a")&&H()}function H(){A.classList.remove("is-open"),document.body.style.overflow="visible",document.removeEventListener("keydown",D),N.removeEventListener("click",G)}function J(){A.classList.add("is-open"),document.body.style.overflow="hidden",document.addEventListener("keydown",D),N.addEventListener("click",G)}K.addEventListener("click",H);X.addEventListener("click",J);const Q=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`
  ...
  `).join("");new Y("#faqAccordion",{duration:300,showMultiple:!1});document.querySelectorAll(".ac-trigger").forEach(e=>{e.addEventListener("click",()=>{const t=e.parentElement.nextElementSibling;t.style.maxHeight?t.style.maxHeight=null:t.style.maxHeight=t.scrollHeight+"px"})});const te="data:image/svg+xml,%3csvg%20width='20'%20height='19'%20viewBox='0%200%2020%2019'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M9.07088%200.612343C9.41462%20-0.204115%2010.5854%20-0.204114%2010.9291%200.612346L12.9579%205.43123C13.1029%205.77543%2013.4306%206.01061%2013.8067%206.0404L19.0727%206.45748C19.9649%206.52814%2020.3267%207.62813%2019.6469%208.2034L15.6348%2011.5987C15.3482%2011.8412%2015.223%2012.2218%2015.3106%2012.5843L16.5363%2017.661C16.744%2018.5211%2015.7969%2019.201%2015.033%2018.7401L10.5245%2016.0196C10.2025%2015.8252%209.7975%2015.8252%209.47548%2016.0196L4.96699%2018.7401C4.20311%2019.201%203.25596%2018.5211%203.46363%2017.661L4.68942%2012.5843C4.77698%2012.2218%204.65182%2011.8412%204.36526%2011.5987L0.353062%208.2034C-0.326718%207.62813%200.0350679%206.52814%200.927291%206.45748L6.19336%206.0404C6.5695%206.01061%206.89716%205.77543%207.04207%205.43123L9.07088%200.612343Z'%20fill='%2302060A'/%3e%3c/svg%3e",se="data:image/svg+xml,%3csvg%20width='20'%20height='19'%20viewBox='0%200%2020%2019'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M10.0078%201.00098L12.0361%205.81934C12.328%206.51225%2012.9837%206.97813%2013.7275%207.03711L18.9854%207.45312L14.9893%2010.835H14.9883C14.4157%2011.3197%2014.1618%2012.086%2014.3389%2012.8193L15.5615%2017.8848C15.5599%2017.8857%2015.5589%2017.8872%2015.5576%2017.8877C15.5559%2017.8869%2015.5532%2017.8858%2015.5498%2017.8838L11.041%2015.1631C10.4014%2014.7772%209.59865%2014.7772%208.95898%2015.1631L4.4502%2017.8838C4.44677%2017.8858%204.4441%2017.8869%204.44238%2017.8877C4.44085%2017.8871%204.43936%2017.8859%204.4375%2017.8848L5.66113%2012.8193C5.8271%2012.1321%205.61431%2011.416%205.11523%2010.9297L5.01172%2010.835L1.01367%207.45312L6.27246%207.03711C7.01627%206.97814%207.67205%206.51246%207.96387%205.81934L9.99121%201.00098C9.99362%201.00054%209.99658%201%2010%201C10.003%201%2010.0056%201.00062%2010.0078%201.00098Z'%20stroke='%2302060A'%20stroke-width='2'/%3e%3c/svg%3e",oe="data:image/svg+xml,%3csvg%20width='20'%20height='19'%20viewBox='0%200%2020%2019'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M9.53125%200.806641C9.70323%200.398163%2010.2968%200.398159%2010.4688%200.806641L12.4971%205.625C12.7155%206.14358%2013.2076%206.49471%2013.7676%206.53906L19.0332%206.95605C19.4909%206.99232%2019.6545%207.54121%2019.3242%207.82129L15.3115%2011.2168C14.8819%2011.5804%2014.6919%2012.1542%2014.8242%2012.7021L16.0508%2017.7783C16.1502%2018.1902%2015.6892%2018.5518%2015.291%2018.3115H15.29L10.7832%2015.5918C10.3023%2015.3016%209.6977%2015.3016%209.2168%2015.5918L4.70898%2018.3115C4.31078%2018.5518%203.84983%2018.1902%203.94922%2017.7783L5.17578%2012.7021C5.30809%2012.1543%205.11814%2011.5805%204.68848%2011.2168L0.675781%207.82129C0.345442%207.54122%200.509097%206.99231%200.966797%206.95605L6.23242%206.53906C6.79243%206.49471%207.28456%206.14369%207.50293%205.625L9.53125%200.806641Z'%20fill='url(%23paint0_linear_8242_16265)'%20stroke='%2302060A'/%3e%3cdefs%3e%3clinearGradient%20id='paint0_linear_8242_16265'%20x1='0'%20y1='9.37158'%20x2='20'%20y2='9.37158'%20gradientUnits='userSpaceOnUse'%3e%3cstop%20offset='0.5'%20stop-color='%2302060A'/%3e%3cstop%20offset='0.5'%20stop-color='%2302060A'%20stop-opacity='0'/%3e%3c/linearGradient%3e%3c/defs%3e%3c/svg%3e",q="https://paw-hut.b.goit.study",ne=`${q}/api/animals`,ie=`${q}/api/categories`,re=`${q}/api/orders`,ae=`${q}/api/feedbacks`;async function le({page:e=1,limit:t=10,categoryId:s}){const o={page:e,limit:t};return s&&(o.categoryId=s),(await k.get(ne,{params:o})).data}async function ce(){return(await k.get(ie)).data}async function de(e){return(await k.post(re,e)).data}async function ue(e=10,t=1){return(await k.get(ae,{params:{page:t,limit:e}})).data}async function pe(){const e=document.querySelector("#feedback");if(!e)return;const t=e.querySelector(".swiper.feedback-swiper"),s=e.querySelector(".swiper-wrapper"),o=e.querySelector(".feedback-swiper-pagination"),n=e.querySelector(".feedback-swiper-button-next"),i=e.querySelector(".feedback-swiper-button-prev");e.querySelector(".loader");try{const l=Math.floor(Math.random()*9)+1,u=(await ue(5,l)).feedbacks;if(!Array.isArray(u)||u.length<3)throw new Error("Not enough feedbacks (min 3 required)");s.innerHTML=u.map(fe).join(""),new U(t,{modules:[F,W],speed:1e3,slidesPerView:1,spaceBetween:16,loop:!1,resistanceRatio:.85,touchRatio:1.2,breakpoints:{768:{slidesPerView:2,spaceBetween:32},1440:{slidesPerView:2,spaceBetween:32}},pagination:{el:o,clickable:!0,dynamicBullets:!0},navigation:{nextEl:n,prevEl:i,disabledClass:"is-disabled"}})}catch(l){console.error(l),p.error({title:"Error",message:l.message,position:"topRight"})}}function fe(e){const t=(e==null?void 0:e.author)??"User",s=(e==null?void 0:e.description)??"",o=me((e==null?void 0:e.rate)??0),n=Math.floor(o),i=o%1>=.5,l=`rating value-${n}${i?" half":""} star-icon`,f=Array.from({length:5}).map(()=>`
    ...
    `}function me(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,t)):0}const x=document.querySelector(".scroll-top"),ge=300;window.addEventListener("scroll",()=>{window.scrollY>ge?x.classList.add("is-on"):x.classList.remove("is-on")});x.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});function he(){const e=document.querySelector("#about-us");if(!e)return;const t=e.querySelector(".swiper.mySwiper"),s=e.querySelector(".swiper-button-next"),o=e.querySelector(".swiper-button-prev"),n=e.querySelector(".swiper-pagination");new U(t,{modules:[F,W],cssMode:!1,navigation:{nextEl:s,prevEl:o},pagination:{el:n,clickable:!0,dynamicBullets:!1},mousewheel:!0,keyboard:!0,speed:1e3,parallax:!0})}const E="/animals-goit-project/assets/sprite-BMUmUqG5.svg";let h=null;function ve(e){h=j.create(`
   <div class="pet-modal">
  ...
  `,{onShow:t=>{const s=document.querySelector(".basicLightbox .pet-modal");s&&(s.style.overflow="auto"),document.body.style.overflow="hidden",t.element().querySelector(".pet-modal-close").addEventListener("click",()=>t.close()),t.element().querySelector(".pet-modal-btn").addEventListener("click",()=>t.close()),document.addEventListener("keydown",_)},onClose:()=>{document.body.style.overflow="visible",document.removeEventListener("keydown",_)}}),h.show()}function _(e){e.key==="Escape"&&h.close()}function be(e){let t=e.replace(/\D/g,"");return t.length===10&&t.startsWith("0")&&(t="38"+t),t}function we(e){const t=j.create(`
    ...
    `,{onShow:s=>{document.body.style.overflow="hidden";const o=s.element(),n=o.querySelector(".modal-order-close-btn"),i=o.querySelector("[data-modal-order-form]"),l=o.querySelector("#user-name"),f=o.querySelector("#user-phone"),u=o.querySelector("#user-comment"),L=o.querySelector(".form-submit-btn");n.addEventListener("click",()=>s.close());const y=v=>{v.key==="Escape"&&s.close()};document.addEventListener("keydown",y),s._onEscClose=y,i.addEventListener("submit",async v=>{var T,O,P;v.preventDefault();const b=l.value.trim(),R=be(f.value),S=u.value.trim();if(!e){p.error({message:"Не обрано тварину",position:"topRight"});return}if(!b||b.length>32){p.error({message:"Імʼя обовʼязкове (до 32 символів)",position:"topRight"}),l.focus();return}if(!/^[0-9]{12}$/.test(R)){p.error({message:"Телефон має містити 12 цифр (приклад: 380955559922)",position:"topRight"}),f.focus();return}if(S&&S.length>500){p.error({message:"Коментар не може перевищувати 500 символів",position:"topRight"}),u.focus();return}const Z={name:b,phone:R,animalId:e,comment:S||void 0};try{L.disabled=!0,$(),await de(Z),p.success({title:"Успішно",message:"Заявку відправлено",position:"topRight"}),s.close()}catch(m){console.error(((T=m==null?void 0:m.response)==null?void 0:T.data)||m.message),p.error({title:"Помилка",message:((P=(O=m==null?void 0:m.response)==null?void 0:O.data)==null?void 0:P.message)||"Не вдалося відправити заявку",position:"topRight"})}finally{B(),L.disabled=!1}})},onClose:s=>{document.body.style.overflow="visible",B(),s!=null&&s._onEscClose&&document.removeEventListener("keydown",s._onEscClose)}});h==null||h.close(),$(),t.show()}//!=============================================================
let r=1,c=1,g=8,V="",w=[];//!=============================================================
async function Le(){const e=await ce(),t=["Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"],s=[...e].sort((o,n)=>{const i=t.indexOf(o.name),l=t.indexOf(n.name);return i===-1?1:l===-1?-1:i-l});ye(s),window.innerWidth>=1440?g=9:g=8,await d()}//!=============================================================
...
function ye(e){const s=[{name:"Всі",_id:""},...e].map(n=>`<li class="pets-filters-item"><button class="pets-filters-btn" data-category-id="${n._id}">${n.name}</button></li>`).join("");a.petsFilters.innerHTML=s;const o=document.querySelector(".pets-filters-btn");o&&o.classList.add("pets-filters-btn-active")}//!=============================================================
function Ee(e,{append:t=!0}={}){const s=e.map(({_id:o,name:n,image:i,species:l,age:f,gender:u,shortDescription:L,categories:y})=>{const v=y.map(b=>`<p class="pet-category">${b.name}</p>`).join("");return`
        <li class="pet-card">
...
async function d({reset:e=!1}={}){$();try{const{animals:t,totalItems:s}=await le({page:r,limit:g,categoryId:V}),o=!e&&window.innerWidth<768;Ee(t,{append:o}),c=Math.ceil(s/g),window.innerWidth<768?(r<c?z():(p.error({message:"Список тварин закінчився =(",position:"topRight"}),C()),e||r++,a.pagination.innerHTML=""):(C(),Ce())}catch(t){console.error("API error:",t)}finally{B()}}//!===============================================================================
function Ce(){if(c<=1||window.innerWidth<768){a.pagination.innerHTML="";return}a.pagination.innerHTML="";const e=document.createElement("button");e.classList.add("pagination-arrow"),e.innerHTML=`
    <svg class="pagination-arrow-img" width="16" height="16">
      <use href="${E}#icon-left"></use>
    </svg>
  `,e.disabled=r===1,e.disabled&&e.classList.add("btn-is-disabled"),e.addEventListener("click",()=>{r--,d({reset:!0}),M()}),a.pagination.appendChild(e);const t=[];if(c<=7)for(let o=1;o<=c;o++)t.push(o);else r<=3?t.push(1,2,3,4,"...",c):r>=c-2?t.push(1,"...",c-3,c-2,c-1,c):t.push(1,"...",r-1,r,r+1,"...",c);t.forEach(o=>{const n=document.createElement("button");n.classList.add("pagination-btn"),n.textContent=o,o===r&&n.classList.add("pagination-btn-active"),o!=="..."?n.addEventListener("click",()=>{r!==o&&(r=o,d({reset:!0}),M())}):(n.disabled=!0,n.classList.add("pagination-dots")),a.pagination.appendChild(n)});const s=document.createElement("button");s.classList.add("pagination-arrow"),s.innerHTML=`
    <svg class="pagination-arrow-img" width="16" height="16">
      <use href="${E}#icon-right"></use>
    </svg>
  `,s.disabled=r===c,s.disabled&&s.classList.add("btn-is-disabled"),s.addEventListener("click",()=>{r++,d({reset:!0}),M()}),a.pagination.appendChild(s)}//!===============================================================================
function M(){document.querySelector("#pets-list").scrollIntoView({behavior:"smooth",block:"start"})}//!===============================================================================
function ke(){const e=document.querySelector(".pet-card");if(!e)return;const t=e.getBoundingClientRect().height;window.scrollBy({top:t,left:0,behavior:"smooth"})}//!===============================================================================
...
a.loadMoreBtn.addEventListener("click",async()=>{C(),await d(),ke()});//!===============================================================================
a.petsFilters.addEventListener("click",e=>{const t=e.target.closest(".pets-filters-btn");t&&(document.querySelectorAll(".pets-filters-btn").forEach(s=>s.classList.remove("pets-filters-btn-active")),t.classList.add("pets-filters-btn-active"),V=t.dataset.categoryId||"",r=1,a.petsList.innerHTML="",d({reset:!0}))});//!=================================================================================
document.addEventListener("click",e=>{const t=e.target.closest(".pet-modal-btn");t&&we(t.dataset.animalId)});//!======================================================================================
document.addEventListener("click",e=>{if(e.target.classList.contains("pet-details-btn")){const t=e.target.dataset.id,s=w.find(o=>o._id===t);if(!s)return;ve(s)}});//!=======================================================================================
let I=window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop";window.addEventListener("resize",()=>{const e=window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop";if(e!==I){if(I=e,e==="mobile"){g=8,a.pagination.innerHTML="",r=1,d({reset:!0}),r++,r<=c?z():C();return}if(e==="tablet"){g=8,r=1,w=[],a.petsList.innerHTML="",d({reset:!0});return}e==="desktop"&&(g=9,r=1,w=[],a.petsList.innerHTML="",d({reset:!0}))}});document.addEventListener("DOMContentLoaded",pe);document.addEventListener("DOMContentLoaded",he);document.addEventListener("DOMContentLoaded",Le);
