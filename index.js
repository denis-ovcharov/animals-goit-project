import{A as V,a as y,S as _,N as T,P as F,i as u,b as j}from"./assets/vendor-CyB7JiL4.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const M=document.getElementById("mobile-menu"),W=document.getElementById("data-burger-close"),Y=document.getElementById("data-burger-open"),K=document.querySelectorAll(".mobile-nav-list a");function x(){M.classList.remove("is-open"),document.body.style.overflow="visible"}function Q(){M.classList.add("is-open"),document.body.style.overflow="hidden"}W.addEventListener("click",x);Y.addEventListener("click",Q);K.forEach(e=>e.addEventListener("click",x));document.addEventListener("keydown",e=>{e.key==="Escape"&&M.classList.contains("is-open")&&x()});const X=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`
  ...
  `}],J=document.getElementById("faqAccordion");J.innerHTML=X.map(e=>`
    <div class="ac">
      <h3 class="ac-header">
  ...
  `).join("");new V("#faqAccordion",{duration:300,showMultiple:!1});document.querySelectorAll(".ac-trigger").forEach(e=>{e.addEventListener("click",()=>{const t=e.parentElement.nextElementSibling;t.style.maxHeight?t.style.maxHeight=null:t.style.maxHeight=t.scrollHeight+"px"})});const w="https://paw-hut.b.goit.study",Z=`${w}/api/animals`,ee=`${w}/api/categories`,te=`${w}/api/orders`,se=`${w}/api/feedbacks`;async function oe({page:e=1,limit:t=10,categoryId:s}){const n={page:e,limit:t};return s&&(n.categoryId=s),(await y.get(Z,{params:n})).data}async function ne(){return(await y.get(ee)).data}async function re(e){return(await y.post(te,e)).data}async function ie(e=10,t=1){return(await y.get(se,{params:{page:t,limit:e}})).data}async function ae(){const e=document.querySelector("#feedback");if(!e)return;const t=e.querySelector(".swiper.feedback-swiper"),s=e.querySelector(".swiper-wrapper"),n=e.querySelector(".feedback-swiper-pagination"),o=e.querySelector(".feedback-swiper-button-next"),r=e.querySelector(".feedback-swiper-button-prev");e.querySelector(".loader");try{const i=Math.floor(Math.random()*9)+1,l=(await ie(5,i)).feedbacks;if(!Array.isArray(l)||l.length<3)throw new Error("Not enough feedbacks (min 3 required)");s.innerHTML=l.map(le).join(""),new _(t,{modules:[T,F],speed:1e3,slidesPerView:1,spaceBetween:16,loop:!1,resistanceRatio:.85,touchRatio:1.2,breakpoints:{768:{slidesPerView:2,spaceBetween:32},1440:{slidesPerView:2,spaceBetween:32}},pagination:{el:n,clickable:!0,dynamicBullets:!0},navigation:{nextEl:o,prevEl:r,disabledClass:"is-disabled"}})}catch(i){console.error(i),u.error({title:"Error",message:i.message,position:"topRight"})}}function le(e){const t=(e==null?void 0:e.author)??"User",s=(e==null?void 0:e.description)??"",n=ce((e==null?void 0:e.rate)??0),o=Math.floor(n),r=n%1>=.5,i=`rating value-${o}${r?" half":""} star-icon`,c=Array.from({length:5}).map(()=>`
        <div class="star">
    ...
    `}function ce(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,t)):0}const S=document.querySelector(".scroll-top"),de=300;window.addEventListener("scroll",()=>{window.scrollY>de?S.classList.add("is-on"):S.classList.remove("is-on")});S.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});function ue(){const e=document.querySelector("#about-us");if(!e)return;const t=e.querySelector(".swiper.mySwiper"),s=e.querySelector(".swiper-button-next"),n=e.querySelector(".swiper-button-prev"),o=e.querySelector(".swiper-pagination");new _(t,{modules:[T,F],cssMode:!1,navigation:{nextEl:s,prevEl:n},pagination:{el:o,clickable:!0,dynamicBullets:!1},mousewheel:!0,keyboard:!0,speed:1e3,parallax:!0})}const N="/animals-goit-project/assets/sprite-BFbGGHrj.svg";let p=null;function pe(e){p=j.create(`
   <div class="pet-modal">
  ...
  `,{onShow:t=>{const s=document.querySelector(".basicLightbox .pet-modal");s&&(s.style.overflow="auto"),document.body.style.overflow="hidden",t.element().querySelector(".pet-modal-close").addEventListener("click",()=>t.close()),t.element().querySelector(".pet-modal-btn").addEventListener("click",()=>t.close()),document.addEventListener("keydown",O)},onClose:()=>{document.body.style.overflow="visible",document.removeEventListener("keydown",O)}}),p.show()}function O(e){e.key==="Escape"&&p.close()}function me(e){let t=e.replace(/\D/g,"");return t.length===10&&t.startsWith("0")&&(t="38"+t),t}function fe(e){const t=j.create(`
    ...
    `,{onShow:s=>{document.body.style.overflow="hidden";const n=s.element(),o=n.querySelector(".modal-order-close-btn"),r=n.querySelector("[data-modal-order-form]"),i=n.querySelector("#user-name"),c=n.querySelector("#user-phone"),l=n.querySelector("#user-comment"),v=n.querySelector(".form-submit-btn");o.addEventListener("click",()=>s.close());const g=m=>{m.key==="Escape"&&s.close()};document.addEventListener("keydown",g),s._onEscClose=g,r.addEventListener("submit",async m=>{var R,A,P;m.preventDefault();const E=i.value.trim(),C=me(c.value),q=l.value.trim();if(!e){u.error({message:"Не обрано тварину",position:"topRight"});return}if(!E||E.length>32){u.error({message:"Імʼя обовʼязкове (до 32 символів)",position:"topRight"}),i.focus();return}if(!/^[0-9]{12}$/.test(C)){u.error({message:"Телефон має містити 12 цифр (приклад: 380955559922)",position:"topRight"}),c.focus();return}if(q&&q.length>500){u.error({message:"Коментар не може перевищувати 500 символів",position:"topRight"}),l.focus();return}const G={name:E,phone:C,animalId:e,comment:q||void 0};try{v.disabled=!0,k(),await re(G),u.success({title:"Успішно",message:"Заявку відправлено",position:"topRight"}),s.close()}catch(d){console.error(((R=d==null?void 0:d.response)==null?void 0:R.data)||d.message),u.error({title:"Помилка",message:((P=(A=d==null?void 0:d.response)==null?void 0:A.data)==null?void 0:P.message)||"Не вдалося відправити заявку",position:"topRight"})}finally{$(),v.disabled=!1}})},onClose:s=>{document.body.style.overflow="visible",$(),s!=null&&s._onEscClose&&document.removeEventListener("keydown",s._onEscClose)}});p==null||p.close(),k(),t.show()}//!=============================================================
let f=1,I=1,h=8,U="",B=[];//!=============================================================
async function he(){const e=await ne(),t=["Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"],s=[...e].sort((n,o)=>{const r=t.indexOf(n.name),i=t.indexOf(o.name);return r===-1?1:i===-1?-1:r-i});ve(s),await L()}//!=============================================================
...
function ge(e){const t=e.map(({_id:s,name:n,image:o,species:r,age:i,gender:c,shortDescription:l,categories:v})=>{const g=v.map(m=>`<p class="pet-category">${m.name}</p>`).join("");return`
        <li class="pet-card">
...
async function L(){k();try{const{animals:e,totalItems:t}=await oe({page:f,limit:h,categoryId:U});if(B.push(...e),e.length===0){b();return}ge(e),I=Math.ceil(t/h),f<I?be():b(),f++}catch(e){console.error("API error:",e)}finally{$()}}//!===============================================================================
function k(){document.body.style.overflowX="hidden",a.loaderPetsList.classList.remove("visually-hidden")}//!===============================================================================
function $(){a.loaderPetsList.classList.add("visually-hidden")}//!===============================================================================
function be(){a.loadMoreBtn.classList.remove("visually-hidden")}//!===============================================================================
function b(){a.loadMoreBtn.classList.add("visually-hidden")}//!===============================================================================
a.loadMoreBtn.addEventListener("click",async()=>{b(),await L(),ye()});//!===============================================================================
function ye(){const e=document.querySelector(".pet-card");if(!e)return;const t=e.getBoundingClientRect().height;window.scrollBy({top:t,left:0,behavior:"smooth"})}//!===============================================================================
a.petsFilters.addEventListener("click",e=>{b();const t=e.target.closest(".pets-filters-btn");t&&(document.querySelectorAll(".pets-filters-btn").forEach(s=>s.classList.remove("pets-filters-btn-active")),t.classList.add("pets-filters-btn-active"),U=t.dataset.categoryId||"",f=1,a.petsList.innerHTML="",L())});//!=================================================================================
document.addEventListener("click",e=>{const t=e.target.closest(".pet-modal-btn");t&&fe(t.dataset.animalId)});//!======================================================================================
document.addEventListener("click",e=>{if(e.target.classList.contains("pet-details-btn")){const t=e.target.dataset.id,s=B.find(n=>n._id===t);if(!s)return;pe(s)}});//!=======================================================================================
const D=window.matchMedia("(min-width: 1440px)");let H=!1;function z(e){const t=e.matches?9:8;if(!H){H=!0,h=t;return}h!==t&&(h=t,f=1,B=[],a.petsList.innerHTML="",L())}D.addEventListener("change",z);z(D);document.addEventListener("DOMContentLoaded",ae);document.addEventListener("DOMContentLoaded",ue);document.addEventListener("DOMContentLoaded",he);
